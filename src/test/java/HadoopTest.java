...
public class HadoopTest {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        conf.addResource(new Path("/home/jiangxuzhao/Environment/hadoop-2.10.1/etc/hadoop/core-site.xml"));
        conf.addResource(new Path("/home/jiangxuzhao/Environment/hadoop-2.10.1/etc/hadoop/hdfs-site.xml"));
